...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void setOneTimeAlarm (Context context, String date, String time, String type, String message){
    ...
    public void setRepeatingAlarm (Context context, String time, String type, String message){
        ...
        Toast.makeText(context, "Repeating alarmset up", Toast.LENGTH_SHORT).show();
    }
